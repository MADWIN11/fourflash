...
cd /d D:\fourflash\platform-tools
if %errorlevel% neq 0 (
...
cls
echo =============================================================
echo Before starting, I want to say that the program requires ROOT.
